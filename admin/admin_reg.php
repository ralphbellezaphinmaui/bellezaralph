...
<body>
    ...
    <div class="overlay">
        <section class="cyberpunk" style="padding: 40px 40px;">
            ...
            <h2 class="cyberpunk">Admin Registration</h2>
            <form name="myForm" action="admin_process.php" onsubmit="return validateForm()" method="post" style="max-width:500px;" required>
