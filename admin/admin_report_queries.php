...
<body>
    ...
    <canvas id="c"></canvas>
    <div class="overlay">
    <section class="cyberpunk" id="call-history" style="background-color:#ff7f27;">


    

<div>
    <h2 class="cyberpunk">Call History</h2>
    <hr>
    <div id = "messages" style="border-style: solid; border-color: red">
        
          <div class = "msg" style="overflow: auto;word-wrap: break-word; color: black;">

            <?php
                $sqli = "SELECT participants,caller,callee,startTime,endTime,user_id,user_firstname,user_lastname,user_email,category,id,user_time FROM calldata ORDER BY id desc LIMIT 1";
                ...
                if(mysqli_num_rows($result) > 0){
                    while($rows=mysqli_fetch_assoc($result)){
                        ...
                        echo "<div style ='padding-left: 8px;color:#ff0000'>";
                        echo $rows['category'];
                        echo "</div>";
                        echo "</b>";
                        echo "<div>";
    ...
    <hr>
  <div class="show" style="margin-left:1vh;">
        
    <button class="cybr-btn" id="show">
