...
<body>
  ...
  <canvas id="c" style="height:99.1vh;"></canvas>
  <div class="overlay">
    <section class="cyberpunk" id="search-box" style="background-color: #ff7f27; ">
      <h1>Search firstname or lastname</h4>
      <form class="cyberpunk" action="" method="get">
        <input class="cyberpunk" type="text" id="searchInput" name="search"/>
        <div></div>
        <button class="cybr-btn" id="search-btn">SEARCH<span aria-hidden></span>
          <span aria-hidden class="cybr-btn__glitch">SEARCH</span>
          <span aria-hidden class="cybr-btn__tag">CITE</span></button>
        <div style="padding: 5px;"></div>
        <h4>Results: </h4>
        <div class="results" style="overflow: auto;word-wrap: break-word; color: black;">
        <?php
          ...
          if(isset($_GET['search']) && !empty($_GET['search'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo "ID: " . $row["id"] . "<br>Firstname: " . $row["firstname"]." <br>" . "Lastname: " .$row["lastname"]. "<br>Email: " . $row["email"] ."<br><br>";
            ...
            mysqli_close($conn);
              ...
              // Display a message if no search parameter is provided
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="admin_report_queries.php" class="nav-link">
          <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="scroll" role="img"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-scroll fa-w-16 fa-9x">
            <g class="fa-group">
              <path fill="currentColor"
  ...
  <div id="notif" class="notifmodal">
        <div class="modal-content">
            <div id="emergency" class="emergency" style="background-color: orange;">
                <h4 style="text-align:center;">Send Emergency Notifications</h4>
